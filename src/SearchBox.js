        ...
        return(
          <div className='search-box'>
            ...
            <div className='search'>
              <input className='search-box-input' value={value} type="text" onChange={getSerchValue}  placeholder="Enola Holmes, The Truman show "/>
            ...
            {movies.map((item) => {
              return(
                ...
                <img src={item.Poster}/>
                <div>
                <button onClick={() => add(item.imdbID)}>Add to the list</button>               
                </div>               
                </div>       
              ) 
            })}                      
